...
<html>
    ...
    <body>
        ...
        <div id="show-family" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.family}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.family}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
