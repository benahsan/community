    ...
    <body>
        ...
        <div id="edit-member" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.member}" method="PUT">
                ...
                <fieldset class="form">
                    <g:if test="${this.member.featuredImageBytes}">
                        <img src="<g:createLink controller="member" action="featuredImage" id="${this.member.id}"/>" width="200"/>
                    </g:if>
                    <f:all bean="member" except="featuredImageBytes,featuredImageContentType"/>
                </fieldset>
                <fieldset class="buttons">
                    <g:link class="edit" action="editFeaturedImage" resource="${this.member}"><g:message code="member.featuredImageUrl.edit.label" default="صورة" /></g:link>
