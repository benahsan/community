...
<html>
    ...
    <body>
        ...
        <div id="show-travel" class="content scaffold-show" role="main">
            ...
            <f:display bean="travel" />
            <g:form resource="${this.travel}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.travel}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
